...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, deleteCookie, parseCookies, setCookie, readBody, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, getResponseStatusText } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/h3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/devalue/index.js';
import destr from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/ohash/dist/index.mjs';
import { propsToString, renderSSRHead } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/radix3/dist/index.mjs';
import { getContext } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unctx/dist/index.mjs';
import { consola } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/errx/dist/index.js';
import { isVNode, version, unref } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/vue/index.mjs';
import { nanoid } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/nanoid/index.js';
import dayjs from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/dayjs/dayjs.min.js';
import sessionDriver from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unstorage/drivers/memory.mjs';
import * as argon2 from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/argon2/argon2.js';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/node_modules/@unhead/shared/dist/index.mjs';
...
const _inlineRuntimeConfig = {
  ...
  "turnstile": {
    "secretKey": "0x4AAAAAAAR14KU5zpzuKkjD1vqr4gY0pS0"
  },
  "public": {
    "session": {
      "api": {
    ...
    "turnstile": {
      "siteKey": "0x4AAAAAAAR14ETNBbnDvfcB"
    },
    "nodeEnv": "development",
    "apiEndpointMaster": "http://localhost:3007/api/v1",
    "apiEndpointGraphql": "http://localhost:3007",
    "apiEndpointSrs": "https://api-srs-dev.ut.ac.id/api-srs-mahasiswa",
    "baseEndpoint": "http://localhost:3000/sso-auth",
    "authSrsEmail": "kurikulum-dev@ut.ac.id",
    "authSrsPassword": "D3vKvR1k241",
    "secretKeyCrypt": "wasilkeren",
    "auth": {
      "computed": {
        "origin": "",
        "pathname": "/api/auth",
      ...
      "provider": {
        ...
        "options": {
          "localStorageKey": "my_app_auth",
          "cookieName": "my_app_auth_token"
        }
      },
      "endpoints": {
        "signIn": {
          "path": "http://192.168.0.179:3333/api/v1/login",
          "method": "post",
          "headers": {
...
const serverAssets = [{"baseName":"server","dir":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/src/server/assets"}];
...
storage$1.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/src/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage$1.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const rootDir = "/Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE";
...
const script = "\"use strict\";(()=>{const a=window,e=document.documentElement,c=window.localStorage,d=[\"dark\",\"light\"],n=c&&c.getItem&&c.getItem(\"utKurikulumColorMode\")||\"light\";let l=n===\"system\"?f():n;const i=e.getAttribute(\"data-color-mode-forced\");i&&(l=i),r(l),a[\"__NUXT_COLOR_MODE__\"]={preference:n,value:l,getColorScheme:f,addColorScheme:r,removeColorScheme:u};function r(o){const t=\"\"+o+\"\",s=\"\";e.classList?e.classList.add(t):e.className+=\" \"+t,s&&e.setAttribute(\"data-\"+s,o)}function u(o){const t=\"\"+o+\"\",s=\"\";e.classList?e.classList.remove(t):e.className=e.className.replace(new RegExp(t,\"g\"),\"\"),s&&e.removeAttribute(\"data-\"+s)}function m(o){return a.matchMedia(\"(prefers-color-scheme\"+o+\")\")}function f(){if(a.matchMedia&&m(\"\").media!==\"not all\"){for(const o of d)if(m(\":\"+o).matches)return o}return\"light\"}})();";

const _izVoWHcwM4 = (function(nitro) {
...
const _lXHNqv = eventHandler(async (event) => {
...
const _ZABTgn = eventHandler(async (event) => {
...
const _08NOxI = eventHandler(async (event) => {
  await deleteSession(event);
  return null;
});

const _CCIGTF = eventHandler((event) => event.context.session);

const _3UkM7o = eventHandler(async (event) => {
  const body = await readBody(event);
  if (checkIfObjectAndContainsIllegalKeys(body)) {
    throw createError({ statusCode: 400, message: "Trying to pass invalid data to session, likely an object with `id` or `createdAt` fields or a non-object" });
  }
...
const _lazy_Nlaccu = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_Nlaccu, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _lXHNqv, lazy: false, middleware: true, method: undefined },
  { route: '/api/session', handler: _ZABTgn, lazy: false, middleware: false, method: "patch" },
  { route: '/api/session', handler: _08NOxI, lazy: false, middleware: false, method: "delete" },
  { route: '/api/session', handler: _CCIGTF, lazy: false, middleware: false, method: "get" },
  { route: '/api/session', handler: _3UkM7o, lazy: false, middleware: false, method: "post" },
  { route: '/**', handler: _lazy_Nlaccu, lazy: true, middleware: false, method: undefined }
];
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"UTF-8"}],"link":[],"style":[],"script":[{"src":"/ckeditor/ckeditor.js","defer":true}],"noscript":[],"charset":"UTF-8","viewport":"width=device-width, initial-scale=1"};
...
const getClientManifest = () => import('file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/wasilmawardi/Documents/work/UT/TTE/BSSN_TTE_FE/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
